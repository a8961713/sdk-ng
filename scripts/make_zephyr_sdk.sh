...
arch_list="arm arm64 arc arc64 nios2 riscv64 sparc mips x86_64 xtensa_espressif_esp32s3 xtensa_sample_controller \
...
parse_toolchain_name file_gcc_xtensa_espressif_esp32s3 xtensa-espressif_esp32s3
